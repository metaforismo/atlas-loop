...
| React viewer | Operational overview, failure triage, searchable session and observed-app history, URL-backed app and workflow workspaces, prefilled session launcher, keyboard command search, live device image, reusable multi-gesture workflows, observed-flow summary, timeline, evidence inspection, Atlas map, visual diffs, and handoff UI |
