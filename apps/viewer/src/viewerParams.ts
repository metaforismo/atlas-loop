...
export function normalizeViewerWorkspace(value: string | null | undefined): "overview" | "tests" | "library" | "sessions" | "apps" | "workflows" | "evidence" {
  if (value === "overview" || value === "tests" || value === "library" || value === "sessions" || value === "apps" || value === "workflows") return value;
  return "evidence";
}
