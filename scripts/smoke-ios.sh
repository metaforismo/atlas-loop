...
run_checkout_by_tap() {
  ...
  run_input_action "01-catalog-visible" assert-visible --id catalog --screen --timeout-ms "$wait_ms"
  ...
  run_input_action "03-product-visible" assert-visible --id product-detail --screen --timeout-ms "$wait_ms"
  ...
  run_input_action "05-cart-visible" assert-visible --id cart --screen --timeout-ms "$wait_ms"
  checkout_step_screenshot "05-cart"
  run_input_action "06-cart-continue" tap-element --id cart.continue --timeout-ms "$wait_ms"
  run_input_action "07-shipping-visible" assert-visible --id shipping --screen --timeout-ms "$wait_ms"
  ...
  run_input_action "09-review-visible" assert-visible --id payment-review --screen --timeout-ms "$wait_ms"
  ...
  run_input_action "11-confirmation-visible" assert-visible --id confirmation --screen --timeout-ms "$wait_ms"
